...
![alt text](data/GhidraFuncTree.png.png)
...
Все три дизассемблера хороши по-своему, у каждого есть свои плюсы и стороны, в которых они лучше других. Так, благодаря комбинации этих трёх программ я узнал о бомбе довольно много.
